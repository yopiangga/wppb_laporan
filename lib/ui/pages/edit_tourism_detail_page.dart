...
class EditTourismDetailPage extends StatefulWidget {
  TourismModel tourism;

  EditTourismDetailPage({this.tourism});
  ...
  @override
  State<EditTourismDetailPage> createState() => _EditTourismDetailPageState();
}

class _EditTourismDetailPageState extends State<EditTourismDetailPage> {
  @override
  Widget build(BuildContext context) {
    List<TourismModel> _tourismList =
        Provider.of<TourismProvider>(context).tourismList;
    setState(() {
      widget._titleController.text = widget.tourism.title;
      widget._locationController.text = widget.tourism.location;
      widget._imageUrlController.text = widget.tourism.imageUrl;
      widget._distanceController.text = widget.tourism.distance;
      widget._weatherController.text = widget.tourism.weather;
      widget._priceController.text = widget.tourism.price;
      widget._descriptionController.text = widget.tourism.description;
    });
    return Scaffold(
      appBar: AppBar(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                var result = await TourismServices.updateTourism(item);
                _tourismList[_tourismList
